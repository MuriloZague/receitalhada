...
class UserRouter extends Router {
    ...
    protected setRoutes(): void {
        ...
        this.router.post('/auth', async (req: Request, res: Response) => { this.controller.authenticateUser(req, res) });
        this.router.post('/email-auth', async (req: Request, res: Response) => { this.controller.authenticateEmailCode(req, res) });
        this.router.post('/forgot-password', async (req: Request, res: Response) => { this.controller.sendForgotPasswordCode(req, res) });
        this.router.post('/reset-password', async (req: Request, res: Response) => { this.controller.authenticateForgotPasswordCode(req, res) });
